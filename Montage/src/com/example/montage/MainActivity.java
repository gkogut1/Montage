...
public class MainActivity extends Activity {
	...
	// request code to get the likes/dislikes from detailed view activity
	private static final int LIKES=2;
	
	// request code to get the comments from detailed view activity
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    	...
    	case LIKES:
    		if (resultCode == RESULT_OK) {
    			boolean hitLike = data.getBooleanExtra("likedBoolean", false);
        		boolean hitDislike = data.getBooleanExtra("dislikedBoolean", false);
        		if (hitLike) {
        			m.addToUpVotes(myClient.getUser());
        		}
